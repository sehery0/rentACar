...
public class MaintenancesController {
	...
	@GetMapping("/getbyid")
	public DataResult<Maintenance> getById(@RequestBody GetMaintenanceResponse readMaintenanceResponse) {
		return this.maintenanceService.getById(readMaintenanceResponse);
	}

	@GetMapping("/getall")
	public DataResult<List<Maintenance>> getAll(GetMaintenanceResponse readMaintenanceResponse) {
