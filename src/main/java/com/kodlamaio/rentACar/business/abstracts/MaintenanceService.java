...
public interface MaintenanceService {
	...
	DataResult<Maintenance> getById(GetMaintenanceResponse readMaintenanceResponse);

	DataResult<List<Maintenance>> getAll(GetMaintenanceResponse readMaintenanceResponse);
